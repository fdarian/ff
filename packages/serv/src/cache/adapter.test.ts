...
describe('CacheAdapter', () => {
  describe('memory', () => {
    ...
    it.effect('set and remove are no-ops', () =>
      Effect.gen(function* () {
        const adapter = CacheAdapter.memory()
        yield* adapter.set('key', { value: 'val', storedAt: 0 }, Duration.minutes(5))
  ...
  describe('redis', () => {
    ...
    it.effect('prefixes keys', () =>
      Effect.gen(function* () {
        ...
        yield* adapter.set(123, { value: 'alice', storedAt: 1000 }, Duration.minutes(5))
    ...
    it.effect('roundtrips entries', () =>
      Effect.gen(function* () {
        ...
        yield* adapter.set(1, { value: 'alice', storedAt: 1000 }, Duration.minutes(5))
  ...
  describe('tiered', () => {
    it.effect('falls through L1 to L2', () =>
      Effect.gen(function* () {
        ...
        yield* tiered.set('k', { value: 'v', storedAt: 1000 }, Duration.minutes(5))
